    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          -->
          <a class="nav-link <?= parse_url($_SERVER["REQUEST_URI"], PHP_URL_PATH) == '/admin/categories.php' ? 'active' : '' ?>" href="categories.php"><?= lang("CATEGORIES") ?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) == '/admin/items.php' ? 'active' : '' ?>" href="items.php"><?= lang("ITEMS") ?></a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?= parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH) == '/admin/members.php' ? 'active' : '' ?>" href="members.php"><?= lang("MEMBERS") ?></a>
        </li>
        <li class="nav-item">
      ...
      <li class="navbar-nav dropdown">
        ...
        <ul class="dropdown-menu user_ul">
          <li><a class="dropdown-item user_options" href="../index.php"><?= lang("VISIT_SHOP") ?></a></li>
          <li><a class="dropdown-item user_options" href="members.php?do=Edit&id=<?= $_SESSION['admin_id'] ?>"><?= lang("EDIT_PROFILE") ?></a>
          </li>
