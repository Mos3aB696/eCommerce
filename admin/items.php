      ...
      <div class="container add-container">
        ...
        <form action="?do=Insert" method='POST'>
          ...
          <div class="mb-3">
            ...
            <div class="input-wrapper">
              <input type="text" class="form-control" id="item-description" name="item-description" required
          ...
          <div class="mb-3">
            ...
            <div class="input-wrapper">
              <input type="text" class="form-control" id="item-price" name="item-price" required
          ...
          <div class="mb-3">
            ...
            <div class="input-wrapper">
              <input type="text" class="form-control" id="item-country" name="item-country" required
        ...
        <div class="container add-container">
          ...
          <form action="?do=Update" method='POST'>
            ...
            <div class="mb-3">
              ...
              <div class="input-wrapper">
                <input type="text" class="form-control" id="item-name" name="item-name" required
                  placeholder="<?= lang('ITEM_NAME_PLACEHOLDER') ?>" value="<?= $item['item_name'] ?>">
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label" for="item-description"><?= lang('ITEM_DESCRIPTION') ?></label>
              <div class="input-wrapper">
                <input type="text" class="form-control" id="item-description" name="item-description" required
                  placeholder="<?= lang('ITEM_DESC_PLACEHOLDER') ?>" value="<?= $item['item_description'] ?>">
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label" for="item-price"><?= lang('ITEM_PRICE') ?></label>
              <div class="input-wrapper">
                <input type="text" class="form-control" id="item-price" name="item-price" required
                  placeholder="<?= lang('ITEM_PRICE_PLACEHOLDER') ?>" value="<?= $item['item_price'] ?>">
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label" for="item-country"><?= lang('ITEM_COUNTRY') ?></label>
              <div class="input-wrapper">
                <input type="text" class="form-control" id="item-country" name="item-country" required
                  placeholder="<?= lang('ITEM_COUNTRY_PLACEHOLDER') ?>" value="<?= $item['country_made'] ?>">
              </div>
            </div>
            <div class="mb-3">
              <label class="form-label" for="item-status"><?= lang('ITEM_STATUS') ?></label>
